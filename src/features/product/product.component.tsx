...
import { selectType } from "./slices/abstract-product.slice";
import { GENERIC_PRODUCT_TYPE } from "./slices/generic-product.slice";
...
import { CUSTOM_PRODUCT_TYPE } from "./slices/custom-product.slice";
